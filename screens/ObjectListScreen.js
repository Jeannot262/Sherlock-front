...
export default function ObjectListScreen({ navigation })
{
    ...
    if(objectList !== null)
    {
        objectsDisplayed = objectList.map((data, i) => {
            return(
                <TouchableOpacity key={i} style={styles.objectContainer} onPress={() => navigation.navigate("Object")}>
                    <View>
    ...
    <>
        <SafeAreaProvider style={styles.container}>
            ...
            <View style={styles.bottomBar}>
                <Button style={styles.addButton} onPress={() => navigation.navigate("NewObject")}>
                    <Text style={styles.objectName}>+</Text>
                </Button>
                <Button style={styles.addButton} onPress={() => navigation.navigate("Login")}>
